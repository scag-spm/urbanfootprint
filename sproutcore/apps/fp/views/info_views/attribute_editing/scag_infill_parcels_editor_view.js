...
Footprint.InfillParcelsEditorView = SC.View.extend({
    classNames: ['footprint-infill-editor-view'],
    childViews: ['infIndexView', 'commentView'],
    ...
    infIndexView: Footprint.EditableTextFieldView.extend({
