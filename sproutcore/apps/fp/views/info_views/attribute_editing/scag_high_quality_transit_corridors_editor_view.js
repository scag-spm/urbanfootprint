...
Footprint.HighQualityTransitCorridorsEditorView = SC.View.extend({
    classNames: ['footprint-high-quality-transit-corridors-editor-view'],
    ...
    commentView: Footprint.EditableTextFieldView.extend({
        layout: {left: 10, right: 30, height: 100, top: 30},
        title: 'Notes',
