...
"""Local development-only settings."""
...
# you can run:
#     ./manage.py --settings=footprint.settings_init footprint_init
# which will set the flag to True.

# DO NOT CHANGE THIS VALUE, IT SHOULD ALWAYS BE 'False' in this file!
