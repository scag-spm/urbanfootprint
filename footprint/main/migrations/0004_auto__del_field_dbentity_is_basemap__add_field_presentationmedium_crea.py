...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DbEntity.is_basemap'
        db.delete_column(u'main_dbentity', 'is_basemap')

        # Adding field 'PresentationMedium.creator'
        db.add_column(u'main_presentationmedium', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='presentation_medium_creator', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'PresentationMedium.updater'
        db.add_column(u'main_presentationmedium', 'updater',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='presentation_medium_updater', to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'Layer.is_basemap'
        db.delete_column(u'main_layer', 'is_basemap')


    def backwards(self, orm):
        # Adding field 'DbEntity.is_basemap'
        db.add_column(u'main_dbentity', 'is_basemap',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'PresentationMedium.creator'
        db.delete_column(u'main_presentationmedium', 'creator_id')

        # Deleting field 'PresentationMedium.updater'
        db.delete_column(u'main_presentationmedium', 'updater_id')

        # Adding field 'Layer.is_basemap'
        db.add_column(u'main_layer', 'is_basemap',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
