...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GroupHierarchy.amigo_project_id'
        db.delete_column(u'main_grouphierarchy', 'amigo_project_id')

        # Deleting field 'GroupHierarchy.arcgis_project_id'
        db.delete_column(u'main_grouphierarchy', 'arcgis_project_id')


    def backwards(self, orm):
        # Adding field 'GroupHierarchy.amigo_project_id'
        db.add_column(u'main_grouphierarchy', 'amigo_project_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'GroupHierarchy.arcgis_project_id'
        db.add_column(u'main_grouphierarchy', 'arcgis_project_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)
