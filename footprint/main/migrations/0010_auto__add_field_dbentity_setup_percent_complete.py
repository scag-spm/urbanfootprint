...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DbEntity.setup_percent_complete'
	# Manual edit setting the default to 100. We want existing DbEntiies marked setup being complete. In the code the default is 0
        db.add_column(u'main_dbentity', 'setup_percent_complete',
                      self.gf('django.db.models.fields.IntegerField')(default=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DbEntity.setup_percent_complete'
        db.delete_column(u'main_dbentity', 'setup_percent_complete')
    ...
    models = {
        ...
        'main.dbentity': {
            ...
            'setup_percent_complete': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
