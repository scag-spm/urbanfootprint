...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Style.name'
        db.alter_column(u'main_style', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'PolicySet.name'
        db.alter_column(u'main_policyset', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'Medium.name'
        db.alter_column(u'main_medium', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'BuiltForm.name'
        db.alter_column(u'main_builtform', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'Behavior.name'
        db.alter_column(u'main_behavior', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'SortType.name'
        db.alter_column(u'main_sorttype', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'BuiltFormExample.name'
        db.alter_column(u'main_builtformexample', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'AnalysisModule.name'
        db.alter_column(u'main_analysismodule', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'DbEntity.name'
        db.alter_column(u'main_dbentity', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'PresentationMedium.name'
        db.alter_column(u'main_presentationmedium', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'Policy.name'
        db.alter_column(u'main_policy', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'BuiltFormSet.name'
        db.alter_column(u'main_builtformset', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'Presentation.name'
        db.alter_column(u'main_presentation', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'PresentationConfiguration.name'
        db.alter_column(u'main_presentationconfiguration', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'BuildingUseDefinition.name'
        db.alter_column(u'main_buildingusedefinition', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'ConfigEntity.name'
        db.alter_column(u'main_configentity', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'PlacetypeComponentCategory.name'
        db.alter_column(u'main_placetypecomponentcategory', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'ApprovalStatus.name'
        db.alter_column(u'main_approvalstatus', 'name', self.gf('django.db.models.fields.CharField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'Style.name'
        db.alter_column(u'main_style', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'PolicySet.name'
        db.alter_column(u'main_policyset', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Medium.name'
        db.alter_column(u'main_medium', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'BuiltForm.name'
        db.alter_column(u'main_builtform', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Behavior.name'
        db.alter_column(u'main_behavior', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'SortType.name'
        db.alter_column(u'main_sorttype', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'BuiltFormExample.name'
        db.alter_column(u'main_builtformexample', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'AnalysisModule.name'
        db.alter_column(u'main_analysismodule', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'DbEntity.name'
        db.alter_column(u'main_dbentity', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'PresentationMedium.name'
        db.alter_column(u'main_presentationmedium', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Policy.name'
        db.alter_column(u'main_policy', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'BuiltFormSet.name'
        db.alter_column(u'main_builtformset', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Presentation.name'
        db.alter_column(u'main_presentation', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'PresentationConfiguration.name'
        db.alter_column(u'main_presentationconfiguration', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'BuildingUseDefinition.name'
        db.alter_column(u'main_buildingusedefinition', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'ConfigEntity.name'
        db.alter_column(u'main_configentity', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'PlacetypeComponentCategory.name'
        db.alter_column(u'main_placetypecomponentcategory', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'ApprovalStatus.name'
        db.alter_column(u'main_approvalstatus', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
