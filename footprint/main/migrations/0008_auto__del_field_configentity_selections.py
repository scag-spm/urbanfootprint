...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ConfigEntity.selections'
        db.delete_column(u'main_configentity', 'selections')


    def backwards(self, orm):
        # Adding field 'ConfigEntity.selections'
        db.add_column(u'main_configentity', 'selections',
                      self.gf('footprint.main.models.config.model_pickled_object_field.SelectionModelsPickledObjectField')(default={'db_entities': {}, 'sets': {}}),
                      keep_default=False)
    ...
    models = {
        ...
        'main.sedupdatertool': {
            'Meta': {'object_name': 'SEDUpdaterTool', '_ormbases': ['main.AnalysisTool']}, u'analysistool_ptr': ('django.db.models.fields.related.OneToOneField', [],
