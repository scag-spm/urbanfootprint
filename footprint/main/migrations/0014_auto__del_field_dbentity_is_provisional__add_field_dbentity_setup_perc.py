...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConfigEntity.setup_percent_complete'
        db.add_column(u'main_configentity', 'setup_percent_complete',
                      self.gf('django.db.models.fields.IntegerField')(default=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConfigEntity.setup_percent_complete'
        db.delete_column(u'main_configentity', 'setup_percent_complete')
