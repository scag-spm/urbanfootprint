...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DbEntity.is_provisional'
        db.delete_column(u'main_dbentity', 'is_provisional')


    def backwards(self, orm):
        # Adding field 'DbEntity.is_provisional'
        db.add_column(u'main_dbentity', 'is_provisional',
